function startGetFormula() {
    var input = document.getElementById("getFormulaInput").value;
    document.getElementById("getFormulaResult").innerHTML = getFormula(parseInt(input, 10)).toString();
}

function resetInputFormulaField() {
    document.getElementById("getFormulaInput").value = "";
    document.getElementById("getFormulaResult").innerHTML = "";
}
